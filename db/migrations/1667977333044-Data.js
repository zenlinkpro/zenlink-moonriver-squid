module.exports = class Data1667977333044 {
  name = 'Data1667977333044'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "stable_swap" ("id" character varying NOT NULL, "address" bytea NOT NULL, "base_swap_address" bytea NOT NULL, "num_tokens" integer NOT NULL, "tokens" text array NOT NULL, "base_tokens" text array NOT NULL, "all_tokens" text array NOT NULL, "balances" numeric array NOT NULL, "lp_token" bytea NOT NULL, "a" numeric NOT NULL, "swap_fee" numeric NOT NULL, "admin_fee" numeric NOT NULL, "virtual_price" numeric NOT NULL, "tvl_usd" text NOT NULL, "volume_usd" text NOT NULL, "stable_swap_info_id" character varying, CONSTRAINT "PK_37316f6fedc29bf95a6f1804c65" PRIMARY KEY ("id"))`)
